...
public class inMemoryTaskManagerTest {
        ...
        void addNewEpicAndSubtasks() {
            ...
            final Subtask savedSubtask3 = taskManager.getSubtaskByID(yandexEducationSubtask2.getId());
            ...
            assertEquals(yandexEducationSubtask2, savedSubtask3, "Подзадачи не совпадают.");

            final List<Epic> epics = taskManager.getEpics();
            assertNotNull(epics, "Эпики не возвращаются.");
            assertEquals(1, epics.size(), "Неверное количество эпиков.");
            assertEquals(yandexEducation, epics.getFirst(), "Эпики не совпадают.");
